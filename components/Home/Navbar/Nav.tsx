...
const Nav = ({ openNav }: Props) => {
  ...
  return (
    <div
      className={` ${
        navBg ? 'bg-[#15803d] shadow-md' : 'fixed'
      } transition-all duration-200 h-[12vh] z-[1000] fixed w-full `}
    >
      <div className="flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto">
        {/* LOGO */}
        <div className="flex items-center space-x-2">
          <div className="w-10 h-10 bg-green-200 rounded-full flex items-center justify-center flex-col">
            <FaGlobe className="w-6 h-6 text-green-700" />
          </div>
        ...
        <div className="flex items-center space-x-4">
          <button className="md:px-12 md:py-2.5 px-8 py-2 text black text-base bg-white hover:bg-gray-200 transitiob-all duration-200 rounded-lg">
            Book Now
          </button>
          {/* BURGER MENU */}
          <HiBars3BottomRight
